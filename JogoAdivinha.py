...
def verifica_grid(grid, jogador):
	...
	#Essa função tem o objetivo de identificar se todas as linhas, colunas e diagnais tem um simbolo
	#específico. De forma mais clara, essa função verifica se há uma linha, das três possíves, uma
	#coluna, também das três possiveis ou se uma das diagnais também foi preenchida totalmente com "X"
	# testando linhas
